...
## [v0.13.8](https://github.com/geeblock/coreth/releases/tag/v0.13.8)
...
## [v0.13.7](https://github.com/geeblock/coreth/releases/tag/v0.13.7)
...
## [v0.13.6](https://github.com/geeblock/coreth/releases/tag/v0.13.6)
...
## [v0.13.5](https://github.com/geeblock/coreth/releases/tag/v0.13.5)
...
## [v0.13.4](https://github.com/geeblock/coreth/releases/tag/v0.13.4)
...
## [v0.13.3](https://github.com/geeblock/coreth/releases/tag/v0.13.3)
...
## [v0.13.2](https://github.com/geeblock/coreth/releases/tag/v0.13.2)
...
## [v0.13.1](https://github.com/geeblock/coreth/releases/tag/v0.13.1)

- Bump AvalancheGo to v1.11.2
- Remove Legacy Gossipper
- Tune default gossip parameters

## [v0.13.0](https://github.com/geeblock/coreth/releases/tag/v0.13.0)

- Bump AvalancheGo to v1.11.1
- Bump minimum Go version to 1.21.7
- Add more error messages to warp backend

## [v0.12.10](https://github.com/geeblock/coreth/releases/tag/v0.12.10)
...
## [v0.12.9](https://github.com/geeblock/coreth/releases/tag/v0.12.9)
...
## [v0.12.8](https://github.com/geeblock/coreth/releases/tag/v0.12.8)

- Bump AvalancheGo to v1.10.15
- Fix crash in prestate tracer on memory read

## [v0.12.7](https://github.com/geeblock/coreth/releases/tag/v0.12.7)

- Bump AvalancheGo to v1.10.14

## [v0.12.6](https://github.com/geeblock/coreth/releases/tag/v0.12.6)
...
## [v0.12.5](https://github.com/geeblock/coreth/releases/tag/v0.12.5)
...
## [v0.12.4](https://github.com/geeblock/coreth/releases/tag/v0.12.4)
...
## [v0.12.3](https://github.com/geeblock/coreth/releases/tag/v0.12.3)

- Migrate go-ethereum changes through v1.11.4
- Downgrade API error log from `Warn` to `Info`

## [v0.12.2](https://github.com/geeblock/coreth/releases/tag/v0.12.2)

- Increase default trie dirty cache size from 256MB to 512MB

## [v0.12.1](https://github.com/geeblock/coreth/releases/tag/v0.12.1)
...
## [v0.12.0](https://github.com/geeblock/coreth/releases/tag/v0.12.0)

- Increase C-Chain block gas limit to 15M in Cortina
- Add Mainnet and Fuji Cortina Activation timestamps

## [v0.11.9](https://github.com/geeblock/coreth/releases/tag/v0.11.9)

- Downgrade SetPreference log from warn to debug

## [v0.11.8](https://github.com/geeblock/coreth/releases/tag/v0.11.8)
...
## [v0.11.7](https://github.com/geeblock/coreth/releases/tag/v0.11.7)
...
## [v0.11.6](https://github.com/geeblock/coreth/releases/tag/v0.11.6)

- Bump AvalancheGo to v1.9.6

## [v0.11.5](https://github.com/geeblock/coreth/releases/tag/v0.11.5)

- Add support for eth_call over VM2VM messaging
- Add config flags for tx pool behavior

## [v0.11.4](https://github.com/geeblock/coreth/releases/tag/v0.11.4)
...
## [v0.11.3](https://github.com/geeblock/coreth/releases/tag/v0.11.3)
...
## [v0.11.2](https://github.com/geeblock/coreth/releases/tag/v0.11.2)
...
## [v0.11.1](https://github.com/geeblock/coreth/releases/tag/v0.11.1)
...
## [v0.11.0](https://github.com/geeblock/coreth/releases/tag/v0.11.0)
...
## [v0.10.0](https://github.com/geeblock/coreth/releases/tag/v0.10.0)
...
## [v0.9.0](https://github.com/geeblock/coreth/releases/tag/v0.9.0)

- Migrate to go-ethereum v1.10.23
- Add API to fetch Chain Config

## [v0.8.16](https://github.com/geeblock/coreth/releases/tag/v0.8.16)
...
## [v0.8.15](https://github.com/geeblock/coreth/releases/tag/v0.8.15)
...
## [v0.8.14](https://github.com/geeblock/coreth/releases/tag/v0.8.14)
...
## [v0.8.13](https://github.com/geeblock/coreth/releases/tag/v0.8.13)

- Bump go-ethereum dependency to v1.10.18
- Parallelize state sync code fetching
- Deprecated CB58 format for API calls

## [v0.8.12](https://github.com/geeblock/coreth/releases/tag/v0.8.12)
...
## [v0.8.11](https://github.com/geeblock/coreth/releases/tag/v0.8.11)
...
## [v0.8.10](https://github.com/geeblock/coreth/releases/tag/v0.8.10)

- Add beta support for fast sync
- Bump trie tip buffer size to 32
- Fix bug in metrics initialization

## [v0.8.9](https://github.com/geeblock/coreth/releases/tag/v0.8.9)
...
## [v0.8.8](https://github.com/geeblock/coreth/releases/tag/v0.8.8)
...
## [v0.8.7](https://github.com/geeblock/coreth/releases/tag/v0.8.7)
...
## [v0.8.6](https://github.com/geeblock/coreth/releases/tag/v0.8.6)
...
## [v0.8.5](https://github.com/geeblock/coreth/releases/tag/v0.8.5)
